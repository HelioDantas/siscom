...
class FuncionarioRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        'identidade'            => 'required|min:11|max:12',
        'dataDeNascimento'      => 'required|date',
        'sexo'                  => 'required|max:2',
        'etnia'                 => 'required|max:2',
        'nacionalidade'         => 'required|max:16',
        'naturalidade'          => 'required|max:25',
        'escolaridade'          => 'nullable|max:20',
        'rua'                   => 'required|max:40',
        ...
        'status'                => 'required',
        'crm'                   =>'max:14|required_if:profissao, M',
        'especialidade1'             => 'nullable|max:19',
        'especialidade2'             => 'nullable|max:19',
        '$p'             => 'nullable|array',
        ];
    }
