...
<div class="container corpo">
    ...
    <div class="col-2">
        ...
        <br><br>
          <label for="nome">CNPJ</label>
             <input type="text" name="nome" id="" class="form-control" placeholder="CNPJ">
    ...
    <div class="form-group">
      ...
      <input type="text" name="nome" id="" class="form-control" placeholder="data adesão">
    ...
    <div class="form-group">
      ...
      <input type="text" name="nome" id="" class="form-control" placeholder="nome do banco">
